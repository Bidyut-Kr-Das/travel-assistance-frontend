...
const Flight_card = ({
  ...
  return (
    <div className="bg-gradient-to-br from-[#2C3E50] to-[#34495E] w-full max-w-md mx-auto text-white px-6 rounded-3xl py-8 flex flex-col gap-6 relative shadow-2xl hover:shadow-3xl transition-all duration-300 overflow-hidden transform hover:-translate-y-1">
